...
# This command attempts to delete a flight that already has reservations. It should fail.
python3 ../solution/manage_flights.py flights2.txt

# These reports should be identical to the "round 1" reports, since the operation 
# on line 20 failed and was rolled back
