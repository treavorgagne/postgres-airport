...
python3 ../solution/add_airports.py  airports1.txt
python3 ../solution/add_aircraft.py  aircraft1.txt
python3 ../solution/manage_flights.py flights1.txt
python3 ../solution/manage_reservations.py reservations1.txt
...
python3 ../solution/report_itinerary.py 12348 > output_report_itinerary_12348_round1.txt

python3 ../solution/add_aircraft.py  aircraft2.txt
python3 ../solution/manage_flights.py flights2.txt
python3 ../solution/add_airports.py  airports2.txt
python3 ../solution/manage_flights.py flights3.txt
python3 ../solution/manage_reservations.py reservations2.txt
...
python3 ../solution/report_itinerary.py 12348 > output_report_itinerary_12348_round2.txt


python3 ../solution/manage_reservations.py reservations3.txt
